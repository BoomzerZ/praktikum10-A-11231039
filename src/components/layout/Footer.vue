<template>
  <footer class="bg-gradient-to-r from-indigo-600 via-purple-500 to-pink-400 text-white">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
          <a href="#" class="flex items-center">
            <img src="/src/assets/LogoPolos.png" class="h-30 me-3 -mt-8" alt="EdVenture Logo" />
          </a>
        </div>
      ...
      <hr class="my-6 border-white/20 sm:mx-auto lg:my-8" />
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-white/80 sm:text-center">
          © 2025 EdVenture. All Rights Reserved.
        </span>
        <div class="flex mt-4 sm:justify-center sm:mt-0">
          ...
          <a href="#" class="text-white/80 hover:text-white ms-5">
