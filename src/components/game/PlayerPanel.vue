<template>
  <div class="player-panel p-4 bg-slate-50 rounded-lg shadow">
    <div class="flex items-center gap-3">
      <div class="avatar w-12 h-12 rounded-full bg-green-500 text-white flex items-center justify-center font-bold">
        P
      </div>
      <div>
