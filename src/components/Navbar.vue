...
<nav :class="['fixed inset-x-0 top-0 z-50 bg-gray-900 transition-shadow duration-200', scrolled ? 'shadow-lg' : '']" :style="{ boxShadow: scrolled ? '0 12px 24px rgba(0,0,0,0.5)' : 'none' }" class="after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
